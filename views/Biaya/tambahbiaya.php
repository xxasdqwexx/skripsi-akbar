...
<br>
	...
	<section class="container bgwhite">
		<form method="POST" action="<?php echo base_url()."Biayaproduksi/tambah_by";?>" enctype="multipart/form-data">
		<br>
						<span>BIAYA BULAN</span>
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="date" name="biaya_tgl" placeholder="contoh : listrik" required>
						</div>
						<span>BIAYA TENAGA KERJA PRODUKSI</span>
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="number" name="byt_produksi" placeholder="contoh : Rp. 100.000" required>
						</div>
						<span>BIAYA OVERHEAD PABRIK PRODUKSI</span>
						<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="number" name="byo_produksi" placeholder="contoh : Rp. 100.000" required>
						</div>
						<span>BAHAN BAKU PRODUKSI</span>
						<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="number" name="bb_produksi" placeholder="contoh : Rp. 100.000" required>
						</div>
						<span>BIAYA OPERASIONAL PRODUKSI</span>
						<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="number" name="bo_produksi" placeholder="contoh : Rp. 100.000" required>
						</div>					
