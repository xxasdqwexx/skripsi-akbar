	...
	<section class="newproduct bgwhite p-t-45 p-b-105">
		<div class="container">
			<div class="sec-title p-b-60">
				...
				<br>
				<p class="t-center">Profit Margin Ratio / Net Profit Margin per-bulan.</p>
				<p style="font-size: 12px;" class="t-center">PMR atau NPM juga dikenal sebagai margin laba bersih, adalah metrik keuangan yang menunjukkan seberapa efisien bisnis dalam mengelola operasinya pada penjualan setelah dikurangi pajak terhadap pendapatan yang diperoleh dari penjualan.</p>
				<br>
				...
				<div class="bgwhite">
					<table class="table-shopping-cart">
						<tr class="table-head">
							...
							<th class="p-l-10">TOTAL PENGELUARAN</th>
							<th class="p-l-10">PROFIT MARGIN RATIO</th>
						</tr>
						...
						<tr class="table-row">
							...
							<td class="p-l-10">Rp <?php echo number_format($harga_pokok_penjualan->byt_produksi+$harga_pokok_penjualan->byo_produksi+$harga_pokok_penjualan->bb_produksi+$harga_pokok_penjualan->bo_produksi,'0',',','.'); ?></td>
							<td class="p-l-10"><?php echo number_format(($harga_pokok_penjualan->subtotal-($harga_pokok_penjualan->byt_produksi+$harga_pokok_penjualan->byo_produksi+$harga_pokok_penjualan->bb_produksi+$harga_pokok_penjualan->bo_produksi))/$harga_pokok_penjualan->subtotal*100,'0',',','.'); ?>%</td>
						</tr>
					<?php endforeach; ?>
					</table>
				</div>
